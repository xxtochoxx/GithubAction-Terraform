...
const folderPath = 'devsecops';

if (!fs.existsSync(folderPath)) {
    fs.mkdirSync(folderPath);
}

// Dar permisos de escritura y lectura a la carpeta
fs.chmodSync(folderPath, '777');

console.log(`Se han otorgado permisos de escritura y lectura a la carpeta ${folderPath}`);
